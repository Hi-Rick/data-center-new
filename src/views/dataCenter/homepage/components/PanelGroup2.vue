<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData2('todo')">
...
<!--          <count-to :start-val="0" :end-val="102400" :duration="2600" class="card-panel-num" />-->
    ...
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData2('usecount')">
...
<!--          <count-to :start-val="0" :end-val="100" :duration="3000" class="card-panel-num" />-->
    ...
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData2('sharetop')">
...
export default {
  ...
  methods: {
    handleSetLineChartData2(type) {
      this.$emit('handleSetLineChartData2', type)
    }
  }
}
</script>
