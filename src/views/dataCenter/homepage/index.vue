...
import resourceChart from "@/views/dataCenter/homepage/components/resourceChart";
import SharetopChart from "@/views/dataCenter/homepage/components/SharetopChart";
